...
<body class="bg-white">
    ...
    <!-- Barra de navegación -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-black rounded-pill px-3 py-2 my-3">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
            <form class="d-flex position-relative my-2 my-lg-0">
                <input class="form-control rounded-pill ps-4 pe-5" type="search" placeholder="Título, autor, xénero..." aria-label="Buscar">
